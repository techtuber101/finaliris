...
export function VisionPipeline() {
  return (
    <section id="vision" className="relative flex flex-col items-center justify-center w-full pb-24">
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-center text-white/70 font-medium text-balance">
            Iris turns bold ideas into living systems — executing vision into reality through perception, intelligence, and action.
          </p>
        </SectionHeader>

        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-6">
          <motion.div whileHover={{ y: -3 }} className="relative flex flex-col items-center text-center">
            <GlassCard className="p-6 flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-white/70">Perceive the world with clarity. Capture signals, patterns, and opportunities.</p>
            </GlassCard>
          ...
          <motion.div whileHover={{ y: -3 }} className="relative flex flex-col items-center text-center">
            <GlassCard className="p-6 flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-white/70">Convert insights into strategies. Model scenarios and chart paths forward.</p>
            </GlassCard>
            <ArrowRight className="hidden md:block absolute -right-5 top-1/2 text-white/40" />
          </motion.div>
          ...
          <motion.div whileHover={{ y: -3 }} className="relative flex flex-col items-center text-center">
            <GlassCard className="p-6 flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-white/70">Deploy autonomous agents that act with precision, speed, and adaptability.</p>
            </GlassCard>
            <ArrowRight className="hidden md:block absolute -right-5 top-1/2 text-white/40" />
          </motion.div>
          ...
          <motion.div whileHover={{ y: -3 }} className="relative flex flex-col items-center text-center">
            <GlassCard className="p-6 flex flex-col items-center gap-3">
              ...
              <h3 className="font-medium">Deliver</h3>
              <p className="text-sm text-white/70">Deliver outcomes that matter — measurable impact, continuous learning, and trust.</p>
            </GlassCard>
          </motion.div>
        </div>
      </div>
